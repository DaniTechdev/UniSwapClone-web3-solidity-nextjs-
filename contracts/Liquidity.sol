...
//Will have to searchf for the updated nonfungiblePositionManager  contract addresss
 ...
 //implementing onERC721Received so this contract can receive custody of erc721 token
    function onERC721Received(
        ...
        uint _tokenId,
        bytes calldata
    ) external override returns (byte4) {
   ...
   function increaseLiquidityCurrentRange ( uint256 amountAdd0, uint256 amountAdd1) external returns(uint128 liquidity, uint256 amount0, uint256 amount0, uint256 amount1) {
